...
INSERT INTO `calculadora`.`diluicao_configuracao` (`medicamento_id`,`via_administracao_id`,`sequencia`,`quantidade_aspirada`,`quantidade_adicionada`,`concentracao`,`diluente`,`modo_preparo`) VALUES (50, 1, 1, null,  2, 250, 'AD', 'Diluir o pó com 2ml e misturar - IM: 2 ml AD');
INSERT INTO `calculadora`.`diluicao_configuracao` (`medicamento_id`,`via_administracao_id`,`sequencia`,`quantidade_aspirada`,`quantidade_adicionada`,`concentracao`,`diluente`,`modo_preparo`) VALUES (50, 1, 2,    2, 18,  25, 'SF', 'Em seringa de 20ml, aspirar 2ml do pó diluído e completar com 18ml SF - Aspirar 1 frasco + 18 ml SF = 25 mg/ml');
